...
זהו הזיכרון המתמשך של חן. **לפני כל חיפוש** היא בודקת כאן (`Grep` על מילות מפתח) אם כבר חיפשה משהו דומה ב-30 הימים האחרונים, כדי להימנע מכפילויות. **אחרי כל חיפוש** היא מוסיפה entry בפורמט הקבוע למטה.
